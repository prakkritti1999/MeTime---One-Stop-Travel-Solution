                            ...
                            <form id="newAccount" onsubmit="submitForm(event)" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control" id="repassword" name="repassword"
                                        placeholder="Confirm Password" required min="8" maxlength="15">
                                ...
                                <div style="display: flex; align-items: center;" class="captcha-container">
                                    ...
                                    <input type="text" id="enteredcaptchacode" class="form-control"
                                        placeholder="Enter CAPTCHA" required maxlength="6">
                                    <button type="button" onclick="refreshCaptcha(event)" class="btn btn-light"
